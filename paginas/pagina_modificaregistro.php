...
$i = 0;
$j = 0;
echo "<form id='modificaregistro' action='pagina_grid.php' method='post' enctype='multipart/form-data' onsubmit='return guardarnuevo()' >";
...
{
echo "<script>
  parent.parent.parent.document.getElementById('alertas').value= 'A';
