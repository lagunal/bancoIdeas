...
$i = 0;
$j = 0;
echo "<form id='agregaregistro' action='pagina_grid_formulario.php' method='post' enctype='multipart/form-data' onsubmit='return guardarnuevo()' >";
  ...
  switch ($datos["data_type"]){
	 case "character varying";
        /*$objetos_pagina .= "document.getElementById('tx".$datos[column_name]."').value"."~";
  	    if($datos[anchocar] > 49)
		{
	    echo "<td ><input type='text' name=tx".$datos[column_name]." id=tx".$datos[column_name]."></td> ";
		}else{
	    $ancho = $datos[anchocar] * 10;
	    echo "<td ><input type='text' name=tx".$datos[column_name]." id=tx".$datos[column_name]." maxlength=".$datos[anchocar]." style='width:".$ancho."'></td> ";
		}*/
